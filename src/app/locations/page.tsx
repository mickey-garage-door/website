    ...
    <>
      <section className="bg-blue-950 text-white py-14 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-orange-400 font-semibold text-sm mb-2">Coverage Area</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {locations.map((loc) => (
              <Link
                ...
                className="group border border-gray-200 rounded-xl p-7 hover:border-blue-900 hover:shadow-lg transition-all duration-200 bg-white"
              >
                <div className="flex items-start gap-3 mb-3">
                  ...
                  <div>
                    <h2 className="font-black text-gray-900 text-lg group-hover:text-blue-900 transition-colors">
                      {loc.city}, CA
                    </h2>
                ...
                <span className="inline-flex items-center gap-1 text-blue-900 font-semibold text-sm group-hover:gap-2 transition-all">
