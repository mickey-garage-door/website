  ...
  return (
    <section className="bg-brand-gradient text-white py-14 px-4">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-blue-100 mb-8 text-lg">{subtext}</p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a
            href={`tel:${company.phonePlain}`}
            className="inline-flex items-center justify-center gap-2 bg-white text-brand-dark font-black px-8 py-4 rounded-lg text-lg hover:bg-blue-50 transition-colors"
          >
        ...
        <p className="mt-5 text-blue-200 text-sm">{company.emergency}</p>
      </div>
    </section>
  );
}
