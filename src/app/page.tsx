...
const homepageFAQs = [
  ...
  },
  {
    ...
    answer: "Yes. Our emergency line is answered around the clock. If your door won't close and your home is unsecured, call us immediately.",
  },
];
...
export default function HomePage() {
  ...
  // Detected server-side — updates automatically when images are added/removed
  const heroImages = getHeroImages();

  return (
    <>
      {/* Hero — full logo gradient (with optional image carousel) */}
      <section className="relative bg-brand-gradient-hero text-white overflow-hidden">
        {/* Carousel fills the background when images exist */}
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 py-16 md:py-24">
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-white/10 text-white text-sm font-semibold px-4 py-1.5 rounded-full mb-5 border border-white/20">
                <span className="animate-pulse text-brand-cyan">●</span>
                Same-Day Service Available
              </div>
              <h1 className="text-4xl md:text-5xl font-black leading-tight mb-4">
                San Diego&apos;s Trusted{" "}
                <span className="text-brand-cyan">Garage Door</span> Experts
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 bg-white text-brand-dark font-black px-7 py-4 rounded-xl text-lg hover:bg-blue-50 transition-colors shadow-lg"
                >
      ...
      <section className="py-16 px-4 bg-surface transition-colors duration-300">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-black text-gray-900 dark:text-gray-100 mb-3">Our Garage Door Services</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {trustPoints.map((point) => (
              <div key={point.title} className="bg-surface rounded-xl p-6 shadow-sm border border-theme text-center transition-colors duration-300">
                ...
                <h3 className="font-bold text-gray-900 dark:text-gray-100 text-base mb-2">{point.title}</h3>
                <p className="text-gray-500 dark:text-gray-400 text-sm leading-relaxed">{point.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 px-4 bg-surface transition-colors duration-300">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 dark:text-gray-400">Real reviews from real customers across San Diego County.</p>
          </div>
          ...
          <div className="text-center mt-8">
            <Link href="/reviews" className="inline-flex items-center gap-2 text-brand-dark dark:text-brand-cyan font-semibold hover:underline">
              Read All Reviews
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
              </svg>
      ...
      {/* Service Areas — dark gradient panel */}
      <section className="py-16 px-4 bg-brand-gradient-hero text-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-10">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 max-w-3xl mx-auto">
            {locations.map((loc) => (
              <Link
                ...
                className="flex items-center gap-2 bg-white/10 hover:bg-white/20 border border-white/20 rounded-lg px-4 py-3 text-sm font-medium transition-colors"
              >
                <svg className="w-3.5 h-3.5 text-brand-cyan shrink-0" fill="currentColor" viewBox="0 0 24 24">
      ...
      <section className="py-16 px-4 bg-surface transition-colors duration-300">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-black text-gray-900 dark:text-gray-100 mb-3">Frequently Asked Questions</h2>
            <p className="text-gray-500 dark:text-gray-400">Common questions about our garage door services in San Diego.</p>
          </div>
