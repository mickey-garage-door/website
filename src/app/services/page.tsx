          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((service) => (
              <Link
                ...
                className="group border border-gray-200 rounded-xl p-7 hover:border-blue-900 hover:shadow-lg transition-all duration-200 bg-white flex flex-col"
              >
                <div className="text-4xl mb-4">{service.icon}</div>
                <h2 className="font-black text-gray-900 text-xl mb-2 group-hover:text-blue-900 transition-colors">
                  {service.title}
                </h2>
