        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="space-y-2 text-sm">
              ...
              <p className="text-gray-400 text-xs">{company.address.full}</p>
            </div>
            <div className="flex gap-3 mt-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-8 h-8 bg-gray-700 rounded flex items-center justify-center hover:bg-pink-600 transition-colors"
